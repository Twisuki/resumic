...
Your data contract is the heart of your application. It lives at [`prisma/_template.prisma`](prisma/_template.prisma) and describes your models:
...
export default definePrismaConfig({
  orm: ormConfig({
    contract: "./prisma/_template.prisma",
    db: {
...
| File                                                 | Purpose                                              |
| ---------------------------------------------------- | ---------------------------------------------------- |
| [`prisma/_template.prisma`](prisma/_template.prisma) | Your data contract — define your models here         |
...
1. Edit [`prisma/_template.prisma`](prisma/_template.prisma) to add or change models.
